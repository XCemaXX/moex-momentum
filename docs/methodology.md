...
- **Делистнутая бумага в портфеле:** за терминальный месяц позиция даёт 0% и выпадает из состава, историю не переписываем — анти-survivorship конвенция. Для денежных выкупов 0% близок к истине, для банкротств завышает; смещение оседает в нижних квартилях и сужает спред Q1−Q4.
